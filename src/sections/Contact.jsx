        ...
        <div className="container h-full flex items-center py-24 md:py-40 ">
          <div className="text-center md:text-left align-center md:max-w-3xl">
            ...
            <a href="mailto:test@gmail.com">
                <button className="reveal cursor-pointer bg-white border-[1px] border-gray-400 text-lg h-[52px] md:w-auto px-12 rounded-[17px] font-semibold inline-flex items-center justify-center gap-2 hover:bg-neutral-200 hover:scale-105 transition-all duration-300">
                    Contact Us
                </button>
            </a>
          </div>
