...
const Hero = () => {
  return (
    <section id="hero-section" className="relative md:h-auto lg:h-[calc(100vh-190px)] 2xl:h-[700px]">
      ...
      {/* 🔵 Subtle Blue Glows (Responsive) */}
      <div className="block md:hidden glow glow--1"></div>

      <div className="glow glow--2"></div>

      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-6 sm:px-10 py-12 md:py-16">
        
        {/* Left Side Text */}
        <div className="z-10  md:text-left max-w-full md:max-w-lg lg:max-w-full md:pt-8 lg:pt-0 2xl:pe-[4rem]">
          ...
          <h1 className="reveal delay-200 capitalize text-[40px] font-semibold md:text-5xl lg:text-[52px] xl:text-header 2xl:text-7xl leading-tight md:font-medium mb-6 md:mb-8">
        ...
        >
          <Image
            src="/images/pexels-cottonbro-4855353.jpg"
            alt="Hero Image"
            fill
            priority
